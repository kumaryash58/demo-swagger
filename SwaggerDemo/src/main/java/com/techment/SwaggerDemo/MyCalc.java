...
{
new MyCalc("Calculator - JavaTpoint");
}
}
class MyDigitButton extends Button implements ActionListener
{
MyCalc cl;
MyDigitButton(int x,int y, int width,int height,String cap, MyCalc clc)
{
super(cap);
...
{
MyCalc cl;
MyOperatorButton(int x,int y, int width,int height,String cap, MyCalc clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
...
if(opText.equals("1/x"))
	...
	try
		...
		cl.displayLabel.setText(MyCalc.getFormattedText(tempd));}
...
cl.displayLabel.setText(MyCalc.getFormattedText(temp));
//cl.number=temp;
}
}
...
{
MyCalc cl;
MyMemoryButton(int x,int y, int width,int height,String cap, MyCalc clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
...
case 'R': 
	cl.displayLabel.setText(MyCalc.getFormattedText(cl.memValue));break;
case 'S':
	cl.memValue=0.0;
case '+': 
...
MySpecialButton(int x,int y, int width,int height,String cap, MyCalc clc)
{
super(cap);
setBounds(x,y,width,height);
this.cl=clc;
